...
margin-bottom:100px;
 background: linear-gradient(to bottom, white, #98FB98);
	...
	<body>
		...
		<div class="aa">
					<h3 class="bb">Crop Subsidy Applications</h3>	</div>
			<div class="dd">
			
							 <?php

include("connection.php");
	$sel="SELECT `r.fname`, `r.lname`,`username`, `password` FROM `tblfarmer` WHERE `cstatus`='n'";
