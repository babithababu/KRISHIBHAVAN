...
tbody tr:nth-child(even)
	...
	<body>
		...
		<h3 class="bb">Applicant Details</h3>	
			<div class="container">
			
							<form method="post" action="regapprovals1.php">
			<?php
...
$ifsc=$row["ifsc"];
		  ...
		  ?>
			<table class="gg">
				...
				<tr>
				<td>First Name:</td><td><input type="text" name="txtname" value="<?php echo $fname;?>"></td>
				<td>Last Name:</td><td><input type="text" name="txthouseno" value="<?php echo $lname;?>"></td>
				</tr><br>
				<tr>
				<td>House Name:</td><td><input type="text" name="txtward" value="<?php echo $hname;?>"></td>
				<td>PO:</td><td><input type="text" name="txthname" value="<?php echo $po; ?>"></td><br>
				</tr>
				<tr>
				<td>Place:</td><td><input type="text" name="txtplace" value="<?php echo $place;?>"></td>
				<td>Pin:</td><td><input type="text" name="email" value="<?php echo $pin; ?>">
				</tr>
				<tr>
				<td>Mob No:</td><td><input type="text" name="txtname" value="<?php echo $mob1;?>"></td>
				<td>Mail:</td><td><input type="text" name="txthouseno" value="<?php echo $mail;?>"></td>
				</tr>
				<tr>
				<td>category:</td><td><input type="text" name="txtward" value="<?php echo $category;?>"></td>
				<td>poverty:</td><td><input type="text" name="txthname" value="<?php echo $poverty; ?>"></td>
				</tr>
				<tr>
				<td>religion:</td><td><input type="text" name="txtplace" value="<?php echo $religion;?>"></td>
				<td>DOB:</td><td><input type="text" name="email" value="<?php echo $dob; ?>">
				</tr>
				<tr>
				<td>Anual Income:</td><td><input type="text" name="txtname" value="<?php echo $income;?>"></td>
				<td>Ration card ID:</td><td><input type="text" name="txthouseno" value="<?php echo $rationid;?>"></td>
				</tr>
				<tr>
				<td>Id No:</td><td><input type="text" name="txtward" value="<?php echo $idno;?>"></td>
				<td>Adhaar Id:</td><td><input type="text" name="txthname" value="<?php echo $adhaarid; ?>"></td>
				</tr>
				<tr>
				<td>Total Area:</td><td><input type="text" name="txtplace" value="<?php echo $area;?>"></td>
				<td>Cultivated Area:</td><td><input type="text" name="email" value="<?php echo $cultivated; ?>">
				</tr>
				<tr>
				<td>Leasable Area:</td><td><input type="text" name="txtname" value="<?php echo $leasable;?>"></td>
				<td>Survey Number:</td><td><input type="text" name="txthouseno" value="<?php echo $survey;?>"></td>
				</tr>
				<tr>
				<td>Bank:</td><td><input type="text" name="txtward" value="<?php echo $bank;?>"></td>
				<td>Branch:</td><td><input type="text" name="txthname" value="<?php echo $branch; ?>"></td>
				</tr>
				<tr>
				<td>Account Number:</td><td><input type="text" name="txtplace" value="<?php echo $acno;?>"></td>
				<td>IFSC code:</td><td><input type="text" name="email" value="<?php echo $ifsc; ?>">
				</tr>
			
 <tr><td colspan="4" align="center"><input type="submit" name="Submit" value="OK"></td></tr>
 </table>
 </form>
