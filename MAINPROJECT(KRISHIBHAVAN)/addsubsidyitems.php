...
margin-bottom:100px;
 background: linear-gradient(to bottom, white, #98FB98);
	...
	<body>
		...
		<div class="aa">
					<h3 class="bb">Subsidy Items</h3>	</div>
			<div class="dd">
...
<td align="left"><input type="text" name="item" class="mm" size="15"></td>
</tr>
<tr>
<td align="left">Category:</td>
<td align="left"><select name="category" width="15px">
        <option value="crop">Crop</option>
		<option value="aggriculturemachine">Aggriculture Machine</option>
    </select>
</td>
</tr>
<tr>
<td align="left">Subsidy Amount(per hectre/per number):</td>
<td align="left"><input type="text" name="amt" class="mm" size="15"></td>
</tr>
<tr>
...
$amt=$_POST["amt"];
$yy="INSERT INTO `tblsubsidy`(`item`, `category`, `amount`) VALUES('$item','$category',$amt)";
mysqli_query($con,$yy);
echo $yy;
							 }
	   ?>
