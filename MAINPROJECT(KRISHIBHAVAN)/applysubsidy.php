...
<tr>
<td colspan=2>
<center><font size=4><b>Aggricutural Machines Subsidy</b></font></center>
</td>
</tr>
<tr><td colspan=2>
...
<td align="left"><select name="machine" width="15px">
        <?php
       $sss=mysqli_query($con,"select *from tblsubsidy where category='machine'");
...
<tr>
<td align="left">No.of Machines:</td>
<td align="left"><input type="text" name="no" class="mm" size="15"></td>
</tr>
<tr>
<td align="left">Purchase Date:</td>
<td align="left"><input type="text" name="purdate" class="mm" size="15"></td>
</tr>
...
include("connection.php");
		...
		if( $_FILES['file']['name'] != "" )
		{
			...
			$s="INSERT INTO `tblmachinesubsidy`(`farid`, `machine`, `no`, `purdate`, `apldate`, `bill`) VALUES($id,'$machine',$no,'$purdate','$apldate','$file')";
			mysqli_query($con,$s);
			echo $s;
			echo "success";
